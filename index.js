...
*/
console.log('task 1b', createMenuItem('quesadilla', 7, 'Lunch'));
console.log(createMenuItem('doomguy cakes', 10, 'Dessert'));
...
console.log('task 2', burger.discount('doctor'));
